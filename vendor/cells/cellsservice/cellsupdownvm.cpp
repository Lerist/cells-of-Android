    ...
    if (argc == 2){
        if(strcmp(argv[1],"up") == 0){
            ...
            system("cd /data/cells && busybox ftpput -u ftp-hw-user -p 1 129.204.70.73 cell1.tar.gz");
             ALOGE("busybox ftpput -u ftp-hw-user -p 1 129.204.70.73 /data/cells/cell1.tar.gz err=\n", strerror(errno));
            ...
            system("cd /data/cells && busybox ftpget -c  -u ftp-hw-user -p 1 129.204.70.73 cell1.tar.gz");
             ALOGE("busybox ftpget -u ftp-hw-user -p 1 129.204.70.73 /data/cells/cell1.tar.gz  err=\n", strerror(errno));
